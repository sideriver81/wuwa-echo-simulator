...
const translations = {
    ja: {
        ...
        setting_finishToLevel25: "目標達成後もLv.25まで育成を続ける",
        targetReachCount: "目標達成回数（試行回数、上限: 1,000万）",
        maxEchos: "最大消費音骸数",
    ...
    en: {
        ...
        setting_finishToLevel25: "Continue leveling to Lv.25 after reaching target",
        targetReachCount: "Target Reach Count (Simulations, Max: 10M)",
